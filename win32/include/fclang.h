...
/* total size: 903 unique leaves: 609 */

#define LEAF0       (238 * sizeof (FcLangCharSet))
#define OFF0        (LEAF0 + 609 * sizeof (FcCharLeaf))
#define NUM0        (OFF0 + 658 * sizeof (uintptr_t))
...
static const struct {
    ...
    FcCharLeaf     leaves[609];
    uintptr_t      leaf_offsets[658];
    FcChar16       numbers[658];
...
} fcLangData = {
{
    ...
    { "uk",  { FC_REF_CONSTANT, 1, OFF(216,390), NUM(216,390) } }, /* 216 */
    { "ur",  { FC_REF_CONSTANT, 1, OFF(217,269), NUM(217,269) } }, /* 217 */
    { "uz",  { FC_REF_CONSTANT, 1, OFF(218,83), NUM(218,83) } }, /* 218 */
    { "ve",  { FC_REF_CONSTANT, 2, OFF(219,391), NUM(219,391) } }, /* 219 */
    { "vi",  { FC_REF_CONSTANT, 4, OFF(220,393), NUM(220,393) } }, /* 220 */
    { "vo",  { FC_REF_CONSTANT, 1, OFF(221,397), NUM(221,397) } }, /* 221 */
    { "vot",  { FC_REF_CONSTANT, 2, OFF(222,398), NUM(222,398) } }, /* 222 */
    { "wa",  { FC_REF_CONSTANT, 1, OFF(223,400), NUM(223,400) } }, /* 223 */
    { "wal",  { FC_REF_CONSTANT, 2, OFF(224,359), NUM(224,359) } }, /* 224 */
    { "wen",  { FC_REF_CONSTANT, 2, OFF(225,401), NUM(225,401) } }, /* 225 */
    { "wo",  { FC_REF_CONSTANT, 2, OFF(226,403), NUM(226,403) } }, /* 226 */
    { "xh",  { FC_REF_CONSTANT, 1, OFF(227,83), NUM(227,83) } }, /* 227 */
    { "yap",  { FC_REF_CONSTANT, 1, OFF(228,405), NUM(228,405) } }, /* 228 */
    { "yi",  { FC_REF_CONSTANT, 1, OFF(229,104), NUM(229,104) } }, /* 229 */
    { "yo",  { FC_REF_CONSTANT, 4, OFF(230,406), NUM(230,406) } }, /* 230 */
    { "za",  { FC_REF_CONSTANT, 1, OFF(231,83), NUM(231,83) } }, /* 231 */
    { "zh-cn",  { FC_REF_CONSTANT, 82, OFF(232,410), NUM(232,410) } }, /* 232 */
    { "zh-hk",  { FC_REF_CONSTANT, 83, OFF(233,492), NUM(233,492) } }, /* 233 */
    { "zh-mo",  { FC_REF_CONSTANT, 83, OFF(234,492), NUM(234,492) } }, /* 234 */
    { "zh-sg",  { FC_REF_CONSTANT, 82, OFF(235,410), NUM(235,410) } }, /* 235 */
    { "zh-tw",  { FC_REF_CONSTANT, 83, OFF(236,575), NUM(236,575) } }, /* 236 */
...
},
{
    ...
    LEAF(390,345),
    /* ve */
    LEAF(391, 22), LEAF(391,346),
    /* vi */
    LEAF(393,347), LEAF(393,348), LEAF(393,349), LEAF(393,350),
    /* vo */
    LEAF(397,351),
    /* vot */
    LEAF(398,352), LEAF(398, 71),
    /* wa */
    LEAF(400,353),
    /* wen */
    LEAF(401, 96), LEAF(401,354),
    /* wo */
    LEAF(403,355), LEAF(403,265),
    /* yap */
    LEAF(405,356),
    /* yo */
    LEAF(406,357), LEAF(406,358), LEAF(406,359), LEAF(406,360),
    /* zh_cn */
    LEAF(410,361), LEAF(410,362), LEAF(410,363), LEAF(410,364),
    LEAF(410,365), LEAF(410,366), LEAF(410,367), LEAF(410,368),
    LEAF(410,369), LEAF(410,370), LEAF(410,371), LEAF(410,372),
    LEAF(410,373), LEAF(410,374), LEAF(410,375), LEAF(410,376),
    LEAF(410,377), LEAF(410,378), LEAF(410,379), LEAF(410,380),
    LEAF(410,381), LEAF(410,382), LEAF(410,383), LEAF(410,384),
    LEAF(410,385), LEAF(410,386), LEAF(410,387), LEAF(410,388),
    LEAF(410,389), LEAF(410,390), LEAF(410,391), LEAF(410,392),
    LEAF(410,393), LEAF(410,394), LEAF(410,395), LEAF(410,396),
    LEAF(410,397), LEAF(410,398), LEAF(410,399), LEAF(410,400),
    LEAF(410,401), LEAF(410,402), LEAF(410,403), LEAF(410,404),
    LEAF(410,405), LEAF(410,406), LEAF(410,407), LEAF(410,408),
    LEAF(410,409), LEAF(410,410), LEAF(410,411), LEAF(410,412),
    LEAF(410,413), LEAF(410,414), LEAF(410,415), LEAF(410,416),
    LEAF(410,417), LEAF(410,418), LEAF(410,419), LEAF(410,420),
    LEAF(410,421), LEAF(410,422), LEAF(410,423), LEAF(410,424),
    LEAF(410,425), LEAF(410,426), LEAF(410,427), LEAF(410,428),
    LEAF(410,429), LEAF(410,430), LEAF(410,431), LEAF(410,432),
    LEAF(410,433), LEAF(410,434), LEAF(410,435), LEAF(410,436),
    LEAF(410,437), LEAF(410,438), LEAF(410,439), LEAF(410,440),
    LEAF(410,441), LEAF(410,442),
    /* zh_hk */
    LEAF(492,443), LEAF(492,444), LEAF(492,445), LEAF(492,446),
    LEAF(492,447), LEAF(492,448), LEAF(492,449), LEAF(492,450),
    LEAF(492,451), LEAF(492,452), LEAF(492,453), LEAF(492,454),
    LEAF(492,455), LEAF(492,456), LEAF(492,457), LEAF(492,458),
    LEAF(492,459), LEAF(492,460), LEAF(492,461), LEAF(492,462),
    LEAF(492,463), LEAF(492,464), LEAF(492,465), LEAF(492,466),
    LEAF(492,467), LEAF(492,468), LEAF(492,469), LEAF(492,470),
    LEAF(492,471), LEAF(492,472), LEAF(492,473), LEAF(492,474),
